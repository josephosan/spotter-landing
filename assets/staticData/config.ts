export default {
  ...
  dashboard: {
    filters: [
      {
        title: 'بر اساس عنوان آموزش',
        filter: 'جستجو عنوان آموزش'
      },
      {
        title: 'دسته بندی',
        filter: [
      ...
      {
        title: 'هزینه اموزش',
        filter: ['همه', 'رایگان', 'غیر رایگان']
      },
      {
        title: 'وضعیت انتشار',
        filter: ['همه', 'منتشر شده', 'در انتظار انتشار']
      },
      {
        title: 'نوع آموزش',
        filter: ['همه', 'اموزش های ویدیویی', 'وبینار ها']
      },
      {
        title: 'بر اساس نام مدرس',
